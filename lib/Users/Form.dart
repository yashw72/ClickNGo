...
class _MyFormPageState extends State<MyFormPage> {
  ...
  Future<void> _fetchDetails() async {
    try {
      ...
      final docRef = firestore.collection('Users').doc(useremail);
  ...
  Future<void> _submitFormData() async {
    try {
      final serialNumberText = _serialNumberController.text;
      final serialNumber = serialNumberText.isNotEmpty ? int.tryParse(serialNumberText) : null;

      if (serialNumber == null) {
        throw Exception('Invalid serial number');
      }
