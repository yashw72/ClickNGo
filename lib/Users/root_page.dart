...
class RootPage extends StatefulWidget {
  ...
  const RootPage({Key? key, required this.email}) : super(key: key);
...
class _RootPageState extends State<RootPage> {
  ...
  Future<void> startScan() async {
    ...
    if (result != '-1') {
      const String expectedPrefix = "https://clickngoform.netlify.app/?organization=";
      ...
      if (result.startsWith(expectedPrefix)) {
        ...
        String? orgEmail = uri.queryParameters['organizationemail'];
