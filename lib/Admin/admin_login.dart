    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (user != null) {
          ...
          await storeUserDetails(user, 'admin'); // Pass the role as 'admin'
          ...
          // Optionally, if you want to store admin email in shared preferences
          // SharedData().setadminEmail(user.email!);
        }
                ...
                TextButton(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              OrgRegistration()), // Navigate to organization registration page
                    );
                  },
                ...
                TextButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              EmailPasswordAuth()), // Go back to user login
                    );
                  },
