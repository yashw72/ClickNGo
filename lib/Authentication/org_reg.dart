...
import '../Admin/admin_dashboard/qr_generation.dart';
...
class _OrgRegistrationState extends State<OrgRegistration> {
  ...
  void generateCode() {
    var uuid = Uuid();
    orgcode = uuid.v4();
    qrdata = 'https://66cb1c3dccec5e00083c8861--clickngoform.netlify.app/?organization=$orgname&organizationid=$orgcode';
  ...
  Future<void> addData(String name, String uuid, String add, String type,
    ...
    try {
      await FirebaseFirestore.instance.collection("Organizations").doc(email).set({
        "Org Name": name,
        "Org Address": add,
        "Org Type": type,
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      try {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => QR(qrdata: qrdata,email:emailController.text.trim(),)),
        );
