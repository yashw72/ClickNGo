    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (user != null) {
          ...
          await storeUserDetails(user, 'faculty'); // Pass the role as 'faculty'
          // HOD Login check
          if (user.email == 'hod@example.com') {
            Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    RootPage2(email: user.email!), // Navigate to HOD page
              ),
            );
          } else {
            ...
            Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    RootPage2(email: user.email!), // Faculty home page
              ),
            );
          }
        }
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => FacultyRegisterScreen()),
                          );
                        },
                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => HODLoginScreen()),
                          );
                        },
                        style: ElevatedButton.styleFrom(
